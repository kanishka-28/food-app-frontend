...
const Index = () => {
    ...
    return (
        <div className="p-20 flex flex-col text-center gap-20 justify-center align-center" >
            ...
            <input type="text" value={url1} onChange={handleURL1} />
            <input type="text" value={url2} onChange={handleURL2} />
            <input type="text" value={url3} onChange={handleURL3} />
            <input type="text" value={url4} onChange={handleURL4} />
            <input type="text" value={url5} onChange={handleURL5} />
        </div>
    )
}
